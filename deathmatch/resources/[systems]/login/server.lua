...
local function loadPlayerData(player, playerId)
    ...
    setElementData(player, "hunger", playerData.hunger or 100)
    setElementData(player, "thirst", playerData.thirst or 100)
    setElementData(player, "stamina", playerData.stamina or 100)
